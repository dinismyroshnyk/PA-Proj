...
INSERT INTO OBRAS (ID_OBRA, ID_UTILIZADORES, TITULO, SUBTITULO, ESTILO_LITERARIO, TIPO_PUBLICACAO, N_PAGINAS, N_PALAVRAS, CODIGO_ISBN, N_EDICAO, DATA_SUBMISSAO, DATA_APROVACAO)
VALUES
